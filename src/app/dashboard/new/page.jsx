...
function CreateTaskForm() {
    ...
    return (
        <>
            {loading ? (<p>Cargando...</p>) : authenticated ? (
                <div className="create-task-container">
                    ...
                    <form onSubmit={handleSubmit} className="task-form">
                        ...
                        <button type="submit" className="submit-button"> {!params.id ? 'Crear' : 'Actualizar'}</button>
                    </form>
                </div>
            ) : (
                <p>Debes estar autenticado para acceder a este contenido.</p>
            )
